      ...
      <Card>
        ...
        <CardContent className="p-4">
          <p className="text-sm text-base-content/70 mb-4">
            Switch between student and teacher views to see both dashboards.
          </p>
          ...
          <div className="flex items-center gap-4 p-4 bg-base-200 rounded-lg mb-4">
            ...
            <div className="flex-1">
              <p className="font-medium">Currently viewing as Student</p>
              <p className="text-sm text-base-content/60">You have access to assignments, grades, and AI tutor</p>
            </div>
          </div>
          ...
          {!showSwitchConfirm ? (
            ...
            >
              <p className="text-sm text-base-content/70">
                Switch to teacher view? You can always switch back.
              </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-base-content/70 mt-2 space-y-1 list-disc list-inside">
                    ...
                    <li>All AI tutor session history</li>
                  </ul>
                </div>
              </div>
