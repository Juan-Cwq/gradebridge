...
export default function TeacherHeader({ profile }: { profile: Profile }) {
    ...
    <header className="sticky top-0 z-30 bg-base-100/80 backdrop-blur-lg border-b border-base-300">
      <div className="flex items-center justify-between px-4 lg:px-6 py-4">
        <div className="flex items-center gap-4 pl-12 lg:pl-0">
          <div className="hidden sm:flex w-10 h-10 rounded-full bg-primary/20 items-center justify-center text-primary font-semibold">
            {profile.avatar_url ? (
              <img
        ...
        <div className="flex items-center gap-3">
          <div className="hidden md:flex items-center gap-2 text-sm text-base-content/70">
            <span className="px-2 py-1 rounded-full bg-primary/10 text-primary font-medium">
              {classCount} Active {classCount === 1 ? "Class" : "Classes"}
            </span>
